            ...
            <form id="settings-form">
              <div class="modal-body d-grid gap-3">
                ...
                <label class="form-check form-switch mb-0">
                  <input class="form-check-input" type="checkbox" name="darkMode" ${D("darkMode")??be?"checked":""} />
                  <span class="form-check-label">Dark mode</span>
                </label>
                <label class="form-check form-switch mb-0">
                  <input class="form-check-input" type="checkbox" name="showMarketsGraphs" ${D("showMarketsGraphs")??Me?"checked":""} />
