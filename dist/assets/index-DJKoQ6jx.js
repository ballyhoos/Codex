(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function a(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(n){if(n.ep)return;n.ep=!0;const o=a(n);fetch(n.href,o)}})();const je=(e,t)=>t.some(a=>e instanceof a);let ot,it;function Zt(){return ot||(ot=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Qt(){return it||(it=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Ge=new WeakMap,qe=new WeakMap,Me=new WeakMap;function Wt(e){const t=new Promise((a,r)=>{const n=()=>{e.removeEventListener("success",o),e.removeEventListener("error",i)},o=()=>{a(W(e.result)),n()},i=()=>{r(e.error),n()};e.addEventListener("success",o),e.addEventListener("error",i)});return Me.set(t,e),t}function Yt(e){if(Ge.has(e))return;const t=new Promise((a,r)=>{const n=()=>{e.removeEventListener("complete",o),e.removeEventListener("error",i),e.removeEventListener("abort",i)},o=()=>{a(),n()},i=()=>{r(e.error||new DOMException("AbortError","AbortError")),n()};e.addEventListener("complete",o),e.addEventListener("error",i),e.addEventListener("abort",i)});Ge.set(e,t)}let Ue={get(e,t,a){if(e instanceof IDBTransaction){if(t==="done")return Ge.get(e);if(t==="store")return a.objectStoreNames[1]?void 0:a.objectStore(a.objectStoreNames[0])}return W(e[t])},set(e,t,a){return e[t]=a,!0},has(e,t){return e instanceof IDBTransaction&&(t==="done"||t==="store")?!0:t in e}};function It(e){Ue=e(Ue)}function Jt(e){return Qt().includes(e)?function(...t){return e.apply(_e(this),t),W(this.request)}:function(...t){return W(e.apply(_e(this),t))}}function ea(e){return typeof e=="function"?Jt(e):(e instanceof IDBTransaction&&Yt(e),je(e,Zt())?new Proxy(e,Ue):e)}function W(e){if(e instanceof IDBRequest)return Wt(e);if(qe.has(e))return qe.get(e);const t=ea(e);return t!==e&&(qe.set(e,t),Me.set(t,e)),t}const _e=e=>Me.get(e);function ta(e,t,{blocked:a,upgrade:r,blocking:n,terminated:o}={}){const i=indexedDB.open(e,t),s=W(i);return r&&i.addEventListener("upgradeneeded",l=>{r(W(i.result),l.oldVersion,l.newVersion,W(i.transaction),l)}),a&&i.addEventListener("blocked",l=>a(l.oldVersion,l.newVersion,l)),s.then(l=>{o&&l.addEventListener("close",()=>o()),n&&l.addEventListener("versionchange",c=>n(c.oldVersion,c.newVersion,c))}).catch(()=>{}),s}const aa=["get","getKey","getAll","getAllKeys","count"],na=["put","add","delete","clear"],Pe=new Map;function st(e,t){if(!(e instanceof IDBDatabase&&!(t in e)&&typeof t=="string"))return;if(Pe.get(t))return Pe.get(t);const a=t.replace(/FromIndex$/,""),r=t!==a,n=na.includes(a);if(!(a in(r?IDBIndex:IDBObjectStore).prototype)||!(n||aa.includes(a)))return;const o=async function(i,...s){const l=this.transaction(i,n?"readwrite":"readonly");let c=l.store;return r&&(c=c.index(s.shift())),(await Promise.all([c[a](...s),n&&l.done]))[0]};return Pe.set(t,o),o}It(e=>({...e,get:(t,a,r)=>st(t,a)||e.get(t,a,r),has:(t,a)=>!!st(t,a)||e.has(t,a)}));const ra=["continue","continuePrimaryKey","advance"],lt={},ze=new WeakMap,kt=new WeakMap,oa={get(e,t){if(!ra.includes(t))return e[t];let a=lt[t];return a||(a=lt[t]=function(...r){ze.set(this,kt.get(this)[t](...r))}),a}};async function*ia(...e){let t=this;if(t instanceof IDBCursor||(t=await t.openCursor(...e)),!t)return;t=t;const a=new Proxy(t,oa);for(kt.set(a,t),Me.set(a,_e(t));t;)yield a,t=await(ze.get(a)||t.continue()),ze.delete(a)}function ct(e,t){return t===Symbol.asyncIterator&&je(e,[IDBIndex,IDBObjectStore,IDBCursor])||t==="iterate"&&je(e,[IDBIndex,IDBObjectStore])}It(e=>({...e,get(t,a,r){return ct(t,a)?ia:e.get(t,a,r)},has(t,a){return ct(t,a)||e.has(t,a)}}));const R=ta("investment_purchase_tracker",3,{async upgrade(e,t,a,r){const n=r,o=e.objectStoreNames.contains("purchases")?n.objectStore("purchases"):null;let i=e.objectStoreNames.contains("inventory")?r.objectStore("inventory"):null;if(e.objectStoreNames.contains("inventory")||(i=e.createObjectStore("inventory",{keyPath:"id"}),i.createIndex("by_purchaseDate","purchaseDate"),i.createIndex("by_productName","productName"),i.createIndex("by_categoryId","categoryId"),i.createIndex("by_active","active"),i.createIndex("by_archived","archived"),i.createIndex("by_updatedAt","updatedAt")),i&&o){let l=await o.openCursor();for(;l;)await i.put(l.value),l=await l.continue()}let s=e.objectStoreNames.contains("categories")?r.objectStore("categories"):null;if(e.objectStoreNames.contains("categories")||(s=e.createObjectStore("categories",{keyPath:"id"}),s.createIndex("by_parentId","parentId"),s.createIndex("by_name","name"),s.createIndex("by_isArchived","isArchived")),e.objectStoreNames.contains("settings")||e.createObjectStore("settings",{keyPath:"key"}),i){let l=await i.openCursor();for(;l;){const c=l.value;let u=!1;typeof c.active!="boolean"&&(c.active=!0,u=!0),typeof c.archived!="boolean"&&(c.archived=!1,u=!0),u&&(c.updatedAt=new Date().toISOString(),await l.update(c)),l=await l.continue()}}if(s){let l=await s.openCursor();for(;l;){const c=l.value;let u=!1;typeof c.active!="boolean"&&(c.active=!0,u=!0),typeof c.isArchived!="boolean"&&(c.isArchived=!1,u=!0),u&&(c.updatedAt=new Date().toISOString(),await l.update(c)),l=await l.continue()}}}});async function sa(){return(await R).getAll("inventory")}async function ke(e){await(await R).put("inventory",e)}async function Qe(e){return(await R).get("inventory",e)}async function la(e){await(await R).delete("inventory",e)}async function ca(){return(await R).getAll("categories")}async function $e(e){await(await R).put("categories",e)}async function $t(e){return(await R).get("categories",e)}async function da(e){await(await R).delete("categories",e)}async function ua(){return(await R).getAll("settings")}async function j(e,t){await(await R).put("settings",{key:e,value:t})}async function xt(e){const a=(await R).transaction(["inventory","categories","settings"],"readwrite");await a.objectStore("inventory").clear(),await a.objectStore("categories").clear(),await a.objectStore("settings").clear();for(const r of e.purchases)await a.objectStore("inventory").put(r);for(const r of e.categories)await a.objectStore("categories").put(r);for(const r of e.settings)await a.objectStore("settings").put(r);await a.done}async function pa(){const t=(await R).transaction(["inventory","categories","settings"],"readwrite");await t.objectStore("inventory").clear(),await t.objectStore("categories").clear(),await t.objectStore("settings").clear(),await t.done}function dt(e){return e==null?!0:typeof e=="string"?e.trim()==="":!1}function fa(e,t){return e.some(r=>r.viewId===t.viewId&&r.field===t.field&&r.op===t.op&&r.value===t.value)?e:[...e,{...t,id:crypto.randomUUID()}]}function At(e,t){const a=new Set([t]);let r=!0;for(;r;){r=!1;for(const n of e)n.linkedToFilterId&&a.has(n.linkedToFilterId)&&!a.has(n.id)&&(a.add(n.id),r=!0)}return e.filter(n=>!a.has(n.id))}function ma(e,t){return e.filter(a=>a.viewId!==t)}function He(e,t,a,r,n){const o=t.filter(s=>s.viewId===a);if(!o.length)return e;const i=new Map(r.map(s=>[s.key,s]));return e.filter(s=>o.every(l=>{var p;const c=i.get(l.field);if(!c)return!0;const u=c.getValue(s);if(l.op==="eq")return String(u)===l.value;if(l.op==="isEmpty")return dt(u);if(l.op==="isNotEmpty")return!dt(u);if(l.op==="contains")return String(u).toLowerCase().includes(l.value.toLowerCase());if(l.op==="inCategorySubtree"){const h=((p=n==null?void 0:n.categoryDescendantsMap)==null?void 0:p.get(l.value))||new Set([l.value]),b=String(u);return h.has(b)}return!0}))}function ba(e){const t=new Map(e.map(r=>[r.id,r])),a=new Map;for(const r of e){const n=a.get(r.parentId)||[];n.push(r),a.set(r.parentId,n)}return{byId:t,children:a}}function Le(e){const{children:t}=ba(e),a=new Map;function r(n){const o=new Set([n]);for(const i of t.get(n)||[])for(const s of r(i.id))o.add(s);return a.set(n,o),o}for(const n of e)a.has(n.id)||r(n.id);return a}function We(e){const t=new Map(e.map(r=>[r.id,r]));function a(r){const n=[],o=[],i=new Set;let s=r;for(;s&&!i.has(s.id);)i.add(s.id),n.unshift(s.id),o.unshift(s.name),s=s.parentId?t.get(s.parentId):void 0;return{ids:n,names:o,depth:Math.max(0,n.length-1)}}return e.map(r=>{const n=a(r);return{...r,pathIds:n.ids,pathNames:n.names,depth:n.depth}})}function Tt(e,t){return[...Le(e).get(t)||new Set([t])]}function ya(e,t){const a=Le(t),r=new Map;for(const n of t){const o=a.get(n.id)||new Set([n.id]);let i=0;for(const s of e)o.has(s.categoryId)&&(i+=s.totalPriceCents);r.set(n.id,i)}return r}const Et=document.querySelector("#app");if(!Et)throw new Error("#app not found");const S=Et;var Ct;const ha=((Ct=document.querySelector('meta[name="app-build-version"]'))==null?void 0:Ct.content)||"dev";let T={kind:"none"},de=null,X=null,z=null,P=null,V=null,ut=!1,we=null,Ve=!1,Fe=null,pe=null,xe=null,pt=!1,ft=!1,te=new Set,mt=!1,Se=null,le=null,fe=null,ce=null,me=null,L=!1,F=0,Y=null,bt=0;const yt=new Map,Ke={schemaVersion:2,exportedAt:"2026-03-31T21:08:59.630Z",settings:[{key:"currencyCode",value:"USD"},{key:"currencySymbol",value:"$"},{key:"themeId",value:"classic"},{key:"darkMode",value:!1},{key:"showGrowthGraph",value:!1},{key:"showMarketsGraphs",value:!0}],categories:[{id:"127726bf-2b61-431a-b9ef-11d01d836123",name:"Bullion",parentId:null,pathIds:["127726bf-2b61-431a-b9ef-11d01d836123"],pathNames:["Bullion"],depth:0,sortOrder:0,evaluationMode:"snapshot",active:!0,isArchived:!1,createdAt:"2026-03-04T03:49:13.236Z",updatedAt:"2026-03-04T08:14:02.783Z"},{id:"6af66667-7211-44ee-865e-5794bb2f3d3c",name:"Gold",parentId:"127726bf-2b61-431a-b9ef-11d01d836123",pathIds:["127726bf-2b61-431a-b9ef-11d01d836123","6af66667-7211-44ee-865e-5794bb2f3d3c"],pathNames:["Bullion","Gold"],depth:1,sortOrder:0,evaluationMode:"spot",active:!0,spotCode:"XAU",isArchived:!1,createdAt:"2026-03-04T03:50:26.185Z",updatedAt:"2026-03-15T23:20:34.173Z"},{id:"364f7799-aa46-43b0-9a23-f9e8ec6b39c2",name:"Mining",parentId:"7d9cb4a4-385e-4f41-9c89-7a71a6385ca3",pathIds:["7d9cb4a4-385e-4f41-9c89-7a71a6385ca3","364f7799-aa46-43b0-9a23-f9e8ec6b39c2"],pathNames:["Shares","Mining"],depth:1,sortOrder:0,active:!0,isArchived:!1,createdAt:"2026-03-31T21:08:59.580Z",updatedAt:"2026-03-31T21:08:59.580Z"},{id:"5c88bcfc-63bc-4c6a-88d4-5fe6c8b68b2b",name:"Cash",parentId:null,pathIds:["5c88bcfc-63bc-4c6a-88d4-5fe6c8b68b2b"],pathNames:["Cash"],depth:0,sortOrder:1,evaluationMode:"snapshot",active:!0,isArchived:!1,createdAt:"2026-03-04T06:14:51.627Z",updatedAt:"2026-03-04T06:14:51.627Z"},{id:"a03c6f4c-bb7f-4520-b49d-c326026634ee",name:"Silver",parentId:"127726bf-2b61-431a-b9ef-11d01d836123",pathIds:["127726bf-2b61-431a-b9ef-11d01d836123","a03c6f4c-bb7f-4520-b49d-c326026634ee"],pathNames:["Bullion","Silver"],depth:1,sortOrder:1,evaluationMode:"spot",active:!0,spotCode:"XAG",isArchived:!1,createdAt:"2026-03-04T03:50:41.282Z",updatedAt:"2026-03-15T23:20:48.705Z"},{id:"3dba18e1-41a2-4cc3-a2fd-f09907a599f7",name:"Super",parentId:null,pathIds:["3dba18e1-41a2-4cc3-a2fd-f09907a599f7"],pathNames:["Super"],depth:0,sortOrder:2,evaluationMode:"snapshot",active:!0,isArchived:!1,createdAt:"2026-03-15T23:48:34.636Z",updatedAt:"2026-03-15T23:48:34.636Z"},{id:"7d9cb4a4-385e-4f41-9c89-7a71a6385ca3",name:"Shares",parentId:null,pathIds:["7d9cb4a4-385e-4f41-9c89-7a71a6385ca3"],pathNames:["Shares"],depth:0,sortOrder:3,active:!0,isArchived:!1,createdAt:"2026-03-31T21:08:47.667Z",updatedAt:"2026-03-31T21:08:47.667Z"}],purchases:[]},ae=JSON.stringify(Ke);function Ae(){return[{id:crypto.randomUUID(),viewId:"categoriesList",field:"active",op:"eq",value:"true",label:"Active: Yes"},{id:crypto.randomUUID(),viewId:"inventoryTable",field:"active",op:"eq",value:"true",label:"Active: Yes"}]}let f={inventoryRecords:[],categories:[],settings:[],reportDateFrom:Lt(365),reportDateTo:new Date().toISOString().slice(0,10),filters:Ae(),showArchivedInventory:!1,showArchivedCategories:!1,exportText:"",importText:ae,storageUsageBytes:null,storageQuotaBytes:null};const ne="USD",re="$",Dt="classic",Te=!1,Ee=!0,Mt=15e3,ht=1100,ga=60*60*1e3,va=[{value:"$",label:"Dollar ($)"},{value:"€",label:"Euro (€)"},{value:"£",label:"Pound (£)"},{value:"¥",label:"Yen/Yuan (¥)"},{value:"₹",label:"Rupee (₹)"},{value:"₩",label:"Won (₩)"},{value:"₽",label:"Ruble (₽)"},{value:"₺",label:"Lira (₺)"},{value:"₫",label:"Dong (₫)"},{value:"₱",label:"Peso (₱)"},{value:"₴",label:"Hryvnia (₴)"}];function wa(e){return e==="classic"}function Ye(e){return wa(e)?e:Dt}function G(){return new Date().toISOString()}function Sa(e){let t=null;for(const a of e)!a.active||a.archived||/^\d{4}-\d{2}-\d{2}$/.test(a.purchaseDate)&&(!t||a.purchaseDate<t)&&(t=a.purchaseDate);return t}function Lt(e){const t=new Date;return t.setDate(t.getDate()-e),t.toISOString().slice(0,10)}function d(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\"/g,"&quot;").replace(/'/g,"&#039;")}function Re(e){if(!Number.isFinite(e)||e<0)return"0 B";const t=["B","KB","MB","GB"];let a=e,r=0;for(;a>=1024&&r<t.length-1;)a/=1024,r+=1;return`${a>=10||r===0?a.toFixed(0):a.toFixed(1)} ${t[r]}`}function I(e){const t=D("currencySymbol")||re,a=Math.abs(e)/100,r=new Intl.NumberFormat(void 0,{style:"decimal",minimumFractionDigits:2,maximumFractionDigits:2}).format(a);return`${e<0?"-":""}${t}${r}`}function De(e){const t=e.trim().replace(/,/g,"");if(!t)return null;const a=Number(t);return Number.isFinite(a)?Math.round(a*100):null}function Ca(e){return e.trim().toUpperCase().replace(/\s+/g,"")}function Ia(e){const t=e.replace(/[\/_-]/g,""),r={XAG:{metal:"XAG"},XAU:{metal:"XAU"},SILVER:{metal:"XAG"},GOLD:{metal:"XAU"},XAGUSD:{metal:"XAG",quoteCurrency:"USD"},XAUUSD:{metal:"XAU",quoteCurrency:"USD"}}[t];if(r)return{kind:"bullion",metal:r.metal,quoteCurrency:r.quoteCurrency,normalizedCode:t};let n=t.match(/^(XAG|XAU)([A-Z]{3})$/);return n?{kind:"bullion",metal:n[1],quoteCurrency:n[2],normalizedCode:t}:(n=t.match(/^(SILVER|GOLD)([A-Z]{3})$/),n?{kind:"bullion",metal:n[1]==="SILVER"?"XAG":"XAU",quoteCurrency:n[2],normalizedCode:t}:null)}function ka(e){const t=Ca(e);if(!t)return null;const a=Ia(t);return a||(/^[A-Z0-9][A-Z0-9.-]{0,19}$/.test(t)?{kind:"equity",symbol:t,normalizedCode:t}:null)}function Je(e){if(typeof e=="number")return Number.isFinite(e)?e:null;if(typeof e!="string")return null;const t=Number(e.replace(/,/g,"").trim());return Number.isFinite(t)?t:null}function be(e,t="",a=[]){if(e==null)return a;const r=Je(e);if(r!=null)return a.push({path:t,value:r}),a;if(Array.isArray(e))return e.forEach((n,o)=>be(n,`${t}[${o}]`,a)),a;if(typeof e=="object")for(const[n,o]of Object.entries(e)){const i=t?`${t}.${n}`:n;be(o,i,a)}return a}function et(e,t){var o;const a=t.map(i=>i.toLowerCase()),r=e.find(i=>{const s=i.path.toLowerCase();return a.some(l=>s.includes(l))});if(r)return r.value;const n=e.find(i=>{const s=i.path.toLowerCase();return s.includes("price")||s.includes("rate")||s.includes("value")});return n?n.value:((o=e[0])==null?void 0:o.value)??null}function $a(e){const t=e.toLowerCase();return t.includes("rate limit")||t.includes("our standard api call frequency is")||t.includes("please consider optimizing your api call frequency")||t.includes("please consider spreading out your free api requests")||t.includes("1 request per second")||t.includes("25 requests per day")}async function Ie(e,t){const a=new URL("https://www.alphavantage.co/query");for(const[r,n]of Object.entries(e))a.searchParams.set(r,n);a.searchParams.set("apikey",t);for(let r=0;r<2;r+=1){const n=Date.now(),o=Math.max(0,bt+ht-n);o>0&&await new Promise(p=>window.setTimeout(p,o)),bt=Date.now();const i=await fetch(a.toString());if(!i.ok)throw new Error(`Request failed (${i.status}).`);const s=await i.json();if(typeof s["Error Message"]=="string")throw new Error(String(s["Error Message"]));const l=typeof s.Note=="string"?s.Note:null,c=typeof s.Information=="string"?s.Information:null,u=l||c;if(u&&$a(u)){if(r===0){await new Promise(p=>window.setTimeout(p,ht+200));continue}throw new Error("Alpha Vantage limit reached. Please wait and retry (free tier: 1 req/sec, 25/day).")}if(l)throw new Error(l);return s}throw new Error("Alpha Vantage request failed.")}function Nt(e){var n;const t=(n=e["Realtime Currency Exchange Rate"])==null?void 0:n["5. Exchange Rate"],a=Je(t);if(a!=null&&a>0)return a;const r=be(e);return et(r,["exchange rate","rate"])}function xa(e){const t=e["Global Quote"],a=Je(t==null?void 0:t["05. price"]);if(a!=null)return a;const r=be(e);return et(r,["global quote","price","close"])}function Aa(e,t){const a=be(e);return et(a,[...t==="XAG"?["silver","xag"]:["gold","xau"],"price","rate","value"])}function Ta(e){const t=["currency","Currency","quote_currency","QuoteCurrency","to_currency"];for(const r of t){const n=e[r];if(typeof n=="string"){const o=n.trim().toUpperCase();if(/^[A-Z]{3}$/.test(o))return o}}const a=Object.entries(e).filter(([,r])=>typeof r=="string");for(const[r,n]of a){const o=n.trim().toUpperCase();if(!/^[A-Z]{3}$/.test(o))continue;if(r.toLowerCase().includes("currency"))return o}return null}async function Ea(e,t,a){if(e===t)return 1;const r=`${e}->${t}`,n=yt.get(r);if(n&&Date.now()-n.cachedAt<ga)return n.rate;const o=await Ie({function:"CURRENCY_EXCHANGE_RATE",from_currency:e,to_currency:t},a),i=Nt(o);if(i==null||i<=0)throw new Error("Could not parse FX exchange rate.");return yt.set(r,{rate:i,cachedAt:Date.now()}),i}function Da(e){return e.toUpperCase().endsWith(".AX")?"AUD":null}function tt(){Y!=null&&(window.clearTimeout(Y),Y=null)}function D(e){var t;return(t=f.settings.find(a=>a.key===e))==null?void 0:t.value}function Ma(e){var o,i;const t=(o=e.find(s=>s.key==="darkMode"))==null?void 0:o.value,a=typeof t=="boolean"?t:Te,r=(i=e.find(s=>s.key==="themeId"))==null?void 0:i.value,n=Ye(r);document.documentElement.setAttribute("data-bs-theme",a?"dark":"light"),document.documentElement.setAttribute("data-app-theme",n)}function B(e){f={...f,...e},q()}function Xe(e){le!=null&&(window.clearTimeout(le),le=null),fe=e,q(),e&&(le=window.setTimeout(()=>{le=null,fe=null,q()},3500))}function U(e){ce!=null&&(window.clearTimeout(ce),ce=null),me=e,q(),e&&(ce=window.setTimeout(()=>{ce=null,me=null,q()},5e3))}function Z(e){T.kind==="none"&&document.activeElement instanceof HTMLElement&&(de=document.activeElement),T=e,q()}function _(){T.kind!=="none"&&(T={kind:"none"},L=!1,tt(),q(),de&&de.isConnected&&de.focus(),de=null)}function Ne(e){const t=e.querySelector('[data-action="refresh-spot-value"]'),a=e.querySelector('[data-role="spot-refresh-status"]');return{button:t,status:a}}function K(e,t,a){const{status:r}=Ne(e);if(!r)return;r.textContent=a,r.classList.remove("text-body-secondary","text-success","text-warning","text-danger");const n={muted:"text-body-secondary",success:"text-success",warning:"text-warning",danger:"text-danger"};r.classList.add(n[t])}function ue(e){const{button:t}=Ne(e);if(!t)return;const a=Date.now()<F;t.disabled=L||a,t.textContent=L?"Getting latest spot value...":"Get latest spot value"}async function qt(e,t,a){const r=ka(e);if(!r)throw new Error("Unsupported spot code format.");let n=null,o=null;if(r.kind==="bullion"){const s=await Ie({function:"GOLD_SILVER_SPOT",symbol:r.metal},a);if(n=Aa(s,r.metal),o=r.quoteCurrency||Ta(s)||"USD",n==null||n<=0){const l=r.quoteCurrency||o||"USD",c=await Ie({function:"CURRENCY_EXCHANGE_RATE",from_currency:r.metal,to_currency:l},a);n=Nt(c),o=l}}else{const s=await Ie({function:"GLOBAL_QUOTE",symbol:r.symbol},a);if(n=xa(s),n==null||n<=0)throw new Error("Could not parse quote price for this symbol.");o=Da(r.symbol)||t}if(n==null||n<=0)throw new Error("Could not parse a valid price for this code.");(!o||!/^[A-Z]{3}$/.test(o))&&(o=t);let i=n;if(o!==t){const s=await Ea(o,t,a);i=n*s}if(!Number.isFinite(i)||i<=0)throw new Error("Received invalid price after conversion.");return Math.round(i*100)}async function La(e){if(L)return;const t=e.querySelector('input[name="mode"]'),a=e.querySelector('select[name="evaluationMode"]'),r=e.querySelector('input[name="spotCode"]'),n=e.querySelector('input[name="spotValue"]');if(!t||t.value!=="edit"||!a||a.value!=="spot"||!r||!n)return;const o=r.value.trim();if(!o){K(e,"warning","Set a code before refreshing.");return}if(Date.now()<F){const l=Math.max(1,Math.ceil((F-Date.now())/1e3));K(e,"muted",`Please wait ${l}s before refreshing again.`),ue(e);return}const i=String(D("alphaVantageApiKey")||"").trim();if(!i){K(e,"warning","Set Alpha Vantage API Key in Settings first.");return}const s=String(D("currencyCode")||ne).trim().toUpperCase();if(!/^[A-Z]{3}$/.test(s)){K(e,"danger","Invalid app currency setting.");return}L=!0,ue(e),K(e,"muted","Refreshing latest value...");try{const l=await qt(o,s,i);n.value=ee(l),K(e,"success","Value refreshed.")}catch(l){const c=l instanceof Error?l.message:"Refresh failed.";K(e,"danger",c)}finally{L=!1,F=Date.now()+Mt,ue(e),tt();const l=Math.max(0,F-Date.now());Y=window.setTimeout(()=>{Y=null;const c=S.querySelector("#category-form");if(c){ue(c);const{status:u}=Ne(c);u&&u.classList.contains("text-body-secondary")&&(u.textContent="")}q()},l)}}async function Na(e){if(L)return;const t=x(e);if(!t){U({tone:"danger",text:"Market not found."});return}if(t.evaluationMode!=="spot"){U({tone:"warning",text:"Refresh is only available for Spot markets."});return}const a=(t.spotCode||"").trim();if(!a){U({tone:"warning",text:"Set a market code before refreshing."});return}if(Date.now()<F){const o=Math.max(1,Math.ceil((F-Date.now())/1e3));U({tone:"warning",text:`Please wait ${o}s before refreshing again.`});return}const r=String(D("alphaVantageApiKey")||"").trim();if(!r){U({tone:"warning",text:"Set Alpha Vantage API Key in Settings first."});return}const n=String(D("currencyCode")||ne).trim().toUpperCase();if(!/^[A-Z]{3}$/.test(n)){U({tone:"danger",text:"Invalid app currency setting."});return}L=!0,U({tone:"warning",text:`Refreshing latest spot price for ${t.name}...`});try{const o=await qt(a,n,r),i={...t,spotValueCents:o,updatedAt:G()};await $e(i),await N(),U({tone:"success",text:`${t.name} spot value updated to ${I(o)}.`})}catch(o){const i=o instanceof Error?o.message:"Refresh failed.";U({tone:"danger",text:i})}finally{L=!1,F=Date.now()+Mt,tt();const o=Math.max(0,F-Date.now());Y=window.setTimeout(()=>{Y=null;const i=S.querySelector("#category-form");if(i){ue(i);const{status:s}=Ne(i);s&&s.classList.contains("text-body-secondary")&&(s.textContent="")}q()},o),q()}}function Pt(){return S.querySelector(".modal-panel")}function Vt(e){return Array.from(e.querySelectorAll('button:not([disabled]), [href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])')).filter(t=>!t.hasAttribute("hidden"))}function qa(){if(T.kind==="none")return;const e=Pt();if(!e)return;const t=document.activeElement;if(t instanceof Node&&e.contains(t))return;(Vt(e)[0]||e).focus()}function Pa(){var e,t;(e=X==null?void 0:X.destroy)==null||e.call(X),(t=z==null?void 0:z.destroy)==null||t.call(z),X=null,z=null}function Ze(){var i;const e=window,t=e.DataTable,a=e.jQuery&&((i=e.jQuery.fn)!=null&&i.DataTable)?e.jQuery:void 0;if(!t&&!a){Fe==null&&(Fe=window.setTimeout(()=>{Fe=null,Ze(),q()},500)),Ve||(Ve=!0,window.addEventListener("load",()=>{Ve=!1,Ze(),q()},{once:!0}));return}const r=S.querySelector("#categories-table"),n=S.querySelector("#inventory-table"),o=(s,l)=>{var c,u;return t?new t(s,l):a?((u=(c=a(s)).DataTable)==null?void 0:u.call(c,l))??null:null};r&&(X=o(r,{dom:"t<'dt-bottom-row row align-items-center g-2 mt-2'<'col-md-6'i><'col-md-6 d-flex justify-content-md-end justify-content-start'p>>",paging:!0,pageLength:100,searching:!1,info:!0,lengthChange:!1,language:{emptyTable:"No categories"},ordering:!1,order:[],columnDefs:[{targets:-1,orderable:!1}]})),n&&(z=o(n,{dom:"t<'dt-bottom-row row align-items-center g-2 mt-2'<'col-md-6'i><'col-md-6 d-flex justify-content-md-end justify-content-start'p>>",paging:!0,pageLength:100,searching:!1,info:!0,lengthChange:!1,language:{emptyTable:"No inventory records"},ordering:{handler:!0,indicators:!0},order:[[0,"asc"]],columnDefs:[{targets:-1,orderable:!1}]}),Ga(n,z))}function Va(e){return e.map(t=>{const a=t.startValueCents??0,r=t.endValueCents??0;return!Number.isFinite(a)||!Number.isFinite(r)||a<=0&&r<=0?null:{id:t.marketId,label:t.marketLabel,startCents:a,endCents:r,changeCents:r-a}}).filter(t=>t!=null).sort((t,a)=>a.endCents-t.endCents)}function Ce(e,t){const a=S.querySelector(`#${e}`),r=S.querySelector(`[data-chart-empty-for="${e}"]`);a&&a.classList.add("d-none"),r&&(r.textContent=t,r.hidden=!1)}function gt(e){const t=S.querySelector(`#${e}`),a=S.querySelector(`[data-chart-empty-for="${e}"]`);t&&t.classList.remove("d-none"),a&&(a.hidden=!0)}function Fa(){P==null||P.dispose(),V==null||V.dispose(),P=null,V=null}function Ra(){ut||(ut=!0,window.addEventListener("resize",()=>{we!=null&&window.clearTimeout(we),we=window.setTimeout(()=>{we=null,P==null||P.resize(),V==null||V.resize()},120)}))}function Oa(){const e=new Map;for(const t of f.categories){if(t.isArchived||!t.active||!t.parentId)continue;const a=e.get(t.parentId)||[];a.push(t.id),e.set(t.parentId,a)}for(const t of e.values())t.sort();return e}function Ba(e,t=26){return e.length<=t?e:`${e.slice(0,t-1)}…`}function ja(e){const t="markets-allocation-chart",a="markets-top-chart",r=S.querySelector(`#${t}`),n=S.querySelector(`#${a}`);if(!r||!n)return;if(!window.echarts){Ce(t,"Chart unavailable: ECharts not loaded."),Ce(a,"Chart unavailable: ECharts not loaded.");return}if(e.length===0){Ce(t,"No eligible market totals to chart."),Ce(a,"No eligible market totals to chart.");return}gt(t),gt(a);const o=window.matchMedia("(max-width: 767.98px)").matches,i=document.documentElement.getAttribute("data-bs-theme")==="dark",s=o?12:14,l=["#3f6d49","#7f6c52","#5a4027","#f2b544","#dc3545","#6f42c1","#20c997","#0b4c92"],c="#20c997",u="#dc3545",p="#0b4c92",h="rgba(108, 117, 125, 0.1)",b=i?"#e9ecef":"#212529",w=i?"#ced4da":"#495057",O=e.map(g=>({name:g.label,value:g.endCents})),C=e.slice(0,5),y=[...C].reverse();new Map(y.map(g=>[g.label,g]));const v=C.reduce((g,A)=>Math.max(g,A.endCents),0),M=v>0?Math.ceil(v*1.2):1;P=window.echarts.init(r),V=window.echarts.init(n),P.setOption({color:l,tooltip:{trigger:"item",textStyle:{fontSize:s},formatter:g=>`${d(g.name)}: ${I(g.value)} (${g.percent??0}%)`},legend:o?{orient:"horizontal",bottom:0,left:12,icon:"circle",textStyle:{color:b,fontSize:s}}:{orient:"vertical",left:12,top:"center",icon:"circle",textStyle:{color:b,fontSize:s}},series:[{type:"pie",z:10,radius:["36%","54%"],center:o?["50%","50%"]:["54%","50%"],data:O,avoidLabelOverlap:!1,itemStyle:{borderColor:i?"#11161d":"#ffffff",borderWidth:3},labelLayout:{hideOverlap:!1},minShowLabelAngle:0,label:{show:!0,position:"outside",color:"#212529",backgroundColor:"rgba(255, 255, 255, 0.92)",borderColor:"rgba(0, 0, 0, 0.2)",borderWidth:1,borderRadius:4,padding:[2,5],fontSize:s,textBorderWidth:0,formatter:g=>{const A=g.percent??0;return`${Math.round(A)}%`}},labelLine:{show:!0,length:8,length2:6,lineStyle:{color:w,width:1}},emphasis:{label:{color:"#212529",backgroundColor:"rgba(255, 255, 255, 0.98)",borderColor:"rgba(0, 0, 0, 0.25)",borderWidth:1,borderRadius:4,padding:[2,5],fontWeight:600}}}]}),V.setOption({color:[c],grid:{left:"4%",right:"10%",top:"8%",bottom:"2%",containLabel:!0},tooltip:{trigger:"axis",axisPointer:{type:"shadow"},textStyle:{fontSize:s},formatter:g=>{var ie,ge;const A=(ie=g[0])==null?void 0:ie.name;if(!A)return"";const ye=((ge=g.find(se=>se.seriesName==="End"))==null?void 0:ge.value)??0,oe=y.find(se=>se.label===A),H=(oe==null?void 0:oe.changeCents)??0,he=H>0?"+":"";return`${d(A)}<br/>End: ${I(ye)}<br/>Change: ${he}${I(H)}`}},xAxis:{type:"value",max:M,axisLabel:{show:!1},splitLine:{show:!1},axisTick:{show:!1},axisLine:{show:!1}},yAxis:{type:"category",data:y.map(g=>g.label),axisLabel:{color:w,fontSize:s,formatter:g=>Ba(g)},axisTick:{show:!1},axisLine:{show:!1}},series:[{name:"End",type:"bar",data:y.map(g=>({value:g.endCents,itemStyle:{color:g.changeCents>0?c:g.changeCents<0?u:p}})),barWidth:30,barCategoryGap:"12%",barGap:"0%",showBackground:!0,backgroundStyle:{color:h},label:{show:!0,position:"right",distance:6,color:b,fontSize:s,formatter:g=>{const A=y[g.dataIndex];return!A||A.changeCents===0?"":`${A.changeCents>0?"+":""}${I(A.changeCents)}`}}}]}),window.requestAnimationFrame(()=>{P==null||P.resize(),V==null||V.resize()}),Ra()}function Ga(e,t){!(t!=null&&t.order)||!t.draw||e.addEventListener("click",a=>{var p,h,b;const r=a.target,n=r==null?void 0:r.closest("thead th");if(!n)return;const o=n.parentElement;if(!(o instanceof HTMLTableRowElement))return;const i=Array.from(o.querySelectorAll("th")),s=i.indexOf(n);if(s<0||s===i.length-1)return;a.preventDefault(),a.stopPropagation();const l=(p=t.order)==null?void 0:p.call(t),c=Array.isArray(l)?l[0]:void 0,u=c&&c[0]===s&&c[1]==="asc"?"desc":"asc";(h=t.order)==null||h.call(t,[[s,u]]),(b=t.draw)==null||b.call(t,!1)},!0)}async function N(){var p,h;const[e,t,a]=await Promise.all([sa(),ca(),ua()]),r=We(t).sort((b,w)=>b.sortOrder-w.sortOrder||b.name.localeCompare(w.name));a.some(b=>b.key==="currencyCode")||(await j("currencyCode",ne),a.push({key:"currencyCode",value:ne})),a.some(b=>b.key==="currencySymbol")||(await j("currencySymbol",re),a.push({key:"currencySymbol",value:re})),a.some(b=>b.key==="darkMode")||(await j("darkMode",Te),a.push({key:"darkMode",value:Te}));const n=a.find(b=>b.key==="themeId"),o=Ye(n==null?void 0:n.value);n?n.value!==o&&(await j("themeId",o),n.value=o):(await j("themeId",o),a.push({key:"themeId",value:o})),a.some(b=>b.key==="showMarketsGraphs")||(await j("showMarketsGraphs",Ee),a.push({key:"showMarketsGraphs",value:Ee})),Ma(a);let i=null,s=null;try{const b=await((h=(p=navigator.storage)==null?void 0:p.estimate)==null?void 0:h.call(p));i=typeof(b==null?void 0:b.usage)=="number"?b.usage:null,s=typeof(b==null?void 0:b.quota)=="number"?b.quota:null}catch{i=null,s=null}let l=f.reportDateFrom,c=f.reportDateTo,u=f.importText;if(r.length>0&&u===ae?u="":r.length===0&&!u.trim()&&(u=ae),!mt){const b=Sa(e);b&&(l=b),c=new Date().toISOString().slice(0,10),mt=!0}f={...f,inventoryRecords:e,categories:r,settings:a,storageUsageBytes:i,storageQuotaBytes:s,reportDateFrom:l,reportDateTo:c,importText:u},q()}function x(e){if(e)return f.categories.find(t=>t.id===e)}function Ua(e){const t=x(e);return t?t.pathNames.join(" / "):"-"}function _a(e){return Ua(e)}function za(e){const t=x(e);return t?t.pathIds.some(a=>{var r;return((r=x(a))==null?void 0:r.active)===!1}):!1}function Ha(e){const t=x(e.categoryId);if(!t)return!1;for(const a of t.pathIds){const r=x(a);if((r==null?void 0:r.active)===!1)return!0}return!1}function Ka(e){return e.active&&!Ha(e)}function ee(e){return e==null?"":(e/100).toFixed(2)}function at(e){const t=e.querySelector('input[name="quantity"]'),a=e.querySelector('input[name="totalPrice"]'),r=e.querySelector('input[name="unitPrice"]');if(!t||!a||!r)return;const n=Number(t.value),o=De(a.value);if(!Number.isFinite(n)||n<=0||o==null||o<0){r.value="";return}r.value=(Math.round(o/n)/100).toFixed(2)}function Ft(e){const t=e.querySelector('input[name="mode"]'),a=e.querySelector('input[name="totalPrice"]'),r=e.querySelector('input[name="baselineValue"]'),n=e.querySelector('input[name="baselineValueDisplay"]');!t||!a||!r||(t.value==="create"&&(r.value=a.value),n&&(n.value=r.value||a.value))}function Rt(e){const t=e.querySelector('select[name="categoryId"]'),a=e.querySelector("[data-quantity-group]"),r=e.querySelector('input[name="quantity"]'),n=e.querySelector("[data-baseline-group]"),o=e.querySelector('input[name="baselineValueDisplay"]'),i=e.querySelector('input[name="baselineValue"]'),s=e.querySelector('input[name="totalPrice"]');if(!t||!a||!r)return;const l=x(t.value),c=(l==null?void 0:l.evaluationMode)==="spot",u=(l==null?void 0:l.evaluationMode)==="snapshot";a.hidden=!c,c?r.readOnly=!1:((!Number.isFinite(Number(r.value))||Number(r.value)<=0)&&(r.value="1"),r.readOnly=!0),n&&(n.hidden=!u),u&&o&&(o.disabled=!0,o.value=(i==null?void 0:i.value)||(s==null?void 0:s.value)||"")}function nt(e){const t=e.querySelector('select[name="evaluationMode"]'),a=e.querySelector("[data-spot-value-group]"),r=e.querySelector('input[name="spotValue"]'),n=e.querySelector("[data-spot-code-group]"),o=e.querySelector('input[name="spotCode"]'),i=e.querySelector("[data-spot-refresh-group]"),s=e.querySelector('[data-action="refresh-spot-value"]');if(!t||!a||!r||!n||!o)return;const l=t.value==="spot",c=String(D("alphaVantageApiKey")||"").trim().length>0;a.hidden=!l,r.disabled=!l,n.hidden=!(l&&c),o.disabled=!(l&&c);const u=o.value.trim().length>0;i&&(i.hidden=!(l&&u&&c)),s&&(s.disabled=!l||!u||!c||L||Date.now()<F)}function Q(e){return e.align==="right"?"col-align-right":e.align==="center"?"col-align-center":""}function Ot(e){return e.active&&!e.archived}function Bt(){const e=f.inventoryRecords.filter(Ot),t=f.categories.filter(o=>!o.isArchived),a=ya(e,t),r=new Map(f.categories.map(o=>[o.id,o])),n=new Map;for(const o of e){const i=r.get(o.categoryId);if(i)for(const s of i.pathIds)n.set(s,(n.get(s)||0)+o.quantity)}return{categoryTotals:a,categoryQty:n}}function jt(e,t){const a=new Map;f.categories.forEach(o=>{if(!o.parentId||o.isArchived)return;const i=a.get(o.parentId)||[];i.push(o),a.set(o.parentId,i)});const r=new Map,n=o=>{const i=r.get(o);if(i!=null)return i;const s=x(o);if(!s||s.isArchived)return r.set(o,0),0;let l=0;const c=a.get(s.id)||[];return c.length>0?l=c.reduce((u,p)=>u+n(p.id),0):s.evaluationMode==="snapshot"?l=e.get(s.id)||0:s.evaluationMode==="spot"&&s.spotValueCents!=null?l=(t.get(s.id)||0)*s.spotValueCents:l=e.get(s.id)||0,r.set(o,l),l};return f.categories.forEach(o=>{o.isArchived||n(o.id)}),r}function Gt(){return[{key:"productName",label:"Name",getValue:e=>e.productName,getDisplay:e=>e.productName,filterable:!0,filterOp:"contains"},{key:"categoryId",label:"Market",getValue:e=>e.categoryId,getDisplay:e=>_a(e.categoryId),filterable:!0,filterOp:"inCategorySubtree"},{key:"quantity",label:"Qty",getValue:e=>{var t;return((t=x(e.categoryId))==null?void 0:t.evaluationMode)==="spot"?e.quantity:""},getDisplay:e=>{var t;return((t=x(e.categoryId))==null?void 0:t.evaluationMode)==="spot"?String(e.quantity):"-"},filterable:!0,filterOp:"eq"},{key:"unitPriceCents",label:"Unit",getValue:e=>{var t;return((t=x(e.categoryId))==null?void 0:t.evaluationMode)==="spot"?e.unitPriceCents??Math.round(e.totalPriceCents/e.quantity):""},getDisplay:e=>{var t;return((t=x(e.categoryId))==null?void 0:t.evaluationMode)==="spot"?I(e.unitPriceCents??Math.round(e.totalPriceCents/e.quantity)):"-"},filterable:!0,filterOp:"eq",align:"right"},{key:"totalPriceCents",label:"Total",getValue:e=>e.totalPriceCents,getDisplay:e=>I(e.totalPriceCents),filterable:!0,filterOp:"eq",align:"right"},{key:"purchaseDate",label:"Date",getValue:e=>e.purchaseDate,getDisplay:e=>e.purchaseDate,filterable:!0,filterOp:"eq"},{key:"active",label:"Active",getValue:e=>e.active,getDisplay:e=>e.active?"Yes":"No",filterable:!0,filterOp:"eq"}]}function Xa(){return[{key:"name",label:"Name",getValue:e=>e.name,getDisplay:e=>e.name,filterable:!0,filterOp:"contains"},{key:"path",label:"Market",getValue:e=>e.pathNames.join(" / "),getDisplay:e=>e.pathNames.join(" / "),filterable:!0,filterOp:"contains"},{key:"spotValueCents",label:"Spot",getValue:e=>e.spotValueCents??"",getDisplay:e=>e.spotValueCents==null?"":I(e.spotValueCents),filterable:!0,filterOp:"eq",align:"right"}]}function Ut(){return f.showArchivedInventory?f.inventoryRecords:f.inventoryRecords.filter(e=>!e.archived)}function Za(){return f.showArchivedCategories?f.categories:f.categories.filter(e=>!e.isArchived)}function Qa(){const e=Gt(),t=Xa(),a=t.filter(p=>p.key==="name"||p.key==="parent"||p.key==="path"),r=t.filter(p=>p.key!=="name"&&p.key!=="parent"&&p.key!=="path"),n=Le(f.categories),o=He(Ut(),f.filters,"inventoryTable",e,{categoryDescendantsMap:n}),{categoryTotals:i,categoryQty:s}=Bt(),l=jt(i,s),c=[...a,{key:"computedQty",label:"Qty",getValue:p=>s.get(p.id)||0,getDisplay:p=>String(s.get(p.id)||0),filterable:!0,filterOp:"eq"},{key:"computedInvestmentCents",label:"Investment",getValue:p=>i.get(p.id)||0,getDisplay:p=>I(i.get(p.id)||0),filterable:!0,filterOp:"eq",align:"right"},...r,{key:"computedTotalCents",label:"Total",getValue:p=>l.get(p.id)||0,getDisplay:p=>I(l.get(p.id)||0),filterable:!0,filterOp:"eq",align:"right"},{key:"active",label:"Active",getValue:p=>p.active&&!p.isArchived,getDisplay:p=>p.active&&!p.isArchived?"Yes":"No",filterable:!0,filterOp:"eq"}],u=He(Za(),f.filters,"categoriesList",c);return{inventoryColumns:e,categoryColumns:c,categoryDescendantsMap:n,filteredInventoryRecords:o,filteredCategories:u,categoryTotals:i,categoryQty:s}}function vt(e,t,a=""){const r=f.filters.filter(n=>n.viewId===e);return`
  ...
  `}function Oe(e,t,a){const r=a.getValue(t),n=a.getDisplay(t),o=r==null?"":String(r),i=a.align==="right"?"text-end":a.align==="center"?"text-center":"text-start";if(!a.filterable)return d(n);if(n.trim()==="")return`<button type="button" class="link-cell btn btn-sm p-0 border-0 bg-transparent ${i} align-baseline" data-action="add-filter" data-view-id="${e}" data-field="${d(a.key)}" data-op="isEmpty" data-value="" data-label="${d(`${a.label}: Empty`)}" title="Filter ${d(a.label)} by empty value"><span class="filter-hit">—</span></button>`;if(e==="inventoryTable"&&a.key==="categoryId"&&typeof t=="object"&&t&&"categoryId"in t){const l=String(t.categoryId),c=za(l);return`<button type="button" class="link-cell btn btn-sm p-0 border-0 bg-transparent ${i} align-baseline" data-action="add-filter" data-view-id="${e}" data-field="${d(a.key)}" data-op="${d(a.filterOp||"eq")}" data-value="${d(o)}" data-label="${d(`${a.label}: ${n}`)}"><span class="filter-hit">${d(n)}${c?' <i class="bi bi-exclamation-diamond-fill text-danger ms-1" aria-label="Inactive category path" title="Inactive category path"></i>':""}</span></button>`}if(e==="categoriesList"&&a.key==="parent"&&typeof t=="object"&&t&&"parentId"in t){const l=t.parentId;if(typeof l=="string"&&l)return`<button type="button" class="link-cell btn btn-sm p-0 border-0 bg-transparent ${i} align-baseline" data-action="add-filter" data-view-id="${e}" data-field="${d(a.key)}" data-op="${d(a.filterOp||"eq")}" data-value="${d(o)}" data-label="${d(`${a.label}: ${n}`)}" data-cross-inventory-category-id="${d(l)}"><span class="filter-hit">${d(n)}</span></button>`}if(e==="categoriesList"&&(a.key==="name"||a.key==="path")&&typeof t=="object"&&t&&"id"in t){const l=String(t.id);return`<button type="button" class="link-cell btn btn-sm p-0 border-0 bg-transparent ${i} align-baseline" data-action="add-filter" data-view-id="${e}" data-field="${d(a.key)}" data-op="${d(a.filterOp||"eq")}" data-value="${d(o)}" data-label="${d(`${a.label}: ${n}`)}" data-cross-inventory-category-id="${d(l)}"><span class="filter-hit">${d(n)}</span></button>`}return`<button type="button" class="link-cell btn btn-sm p-0 border-0 bg-transparent ${i} align-baseline" data-action="add-filter" data-view-id="${e}" data-field="${d(a.key)}" data-op="${d(a.filterOp||"eq")}" data-value="${d(o)}" data-label="${d(`${a.label}: ${n}`)}"><span class="filter-hit">${d(n)}</span></button>`}function _t(e){return Number.isFinite(e)?Number.isInteger(e)?String(e):new Intl.NumberFormat(void 0,{minimumFractionDigits:0,maximumFractionDigits:4}).format(e):""}function Wa(e,t){const a=e.map((r,n)=>{let o=0,i=!1;for(const l of t){const c=r.getValue(l);typeof c=="number"&&Number.isFinite(c)&&(o+=c,i=!0)}const s=i?String(r.key).toLowerCase().includes("cents")?I(o):_t(o):n===0?"Totals":"";return`<th class="${Q(r)}">${d(s)}</th>`});return a.push('<th class="actions-col" aria-hidden="true"></th>'),`<tfoot><tr>${a.join("")}</tr></tfoot>`}function Ya(e,t){const a=new Set(t.map(i=>i.id)),r=t.filter(i=>!i.parentId||!a.has(i.parentId)),n=new Set(["computedQty","computedInvestmentCents","computedTotalCents"]),o=e.map((i,s)=>{const l=n.has(String(i.key))?r:t;let c=0,u=!1;for(const h of l){const b=i.getValue(h);typeof b=="number"&&Number.isFinite(b)&&(c+=b,u=!0)}const p=u?String(i.key).toLowerCase().includes("cents")?I(c):_t(c):s===0?"Totals":"";return`<th class="${Q(i)}">${d(p)}</th>`});return o.push('<th class="actions-col" aria-hidden="true"></th>'),`<tfoot><tr>${o.join("")}</tr></tfoot>`}function wt(e,t=!1){return/^\d{4}-\d{2}-\d{2}$/.test(e)?Date.parse(`${e}T${t?"23:59:59":"00:00:00"}Z`):null}function Ja(e,t){const a=[...e];return a.filter(n=>{for(const o of a){if(o===n)continue;const i=t.get(o);if(i!=null&&i.has(n))return!1}return!0})}function en(e){const t=new Set(f.filters.filter(r=>r.viewId==="categoriesList").map(r=>r.id)),a=new Set(f.filters.filter(r=>r.viewId==="inventoryTable"&&r.field==="categoryId"&&r.op==="inCategorySubtree"&&!!r.linkedToFilterId&&t.has(r.linkedToFilterId)).map(r=>r.value));return a.size>0?Ja(a,e):f.categories.filter(r=>!r.isArchived&&r.active&&r.parentId==null).map(r=>r.id)}function tn(e){const t=en(e),a=Oa(),{categoryTotals:r,categoryQty:n}=Bt(),o=jt(r,n),i=new Map;for(const C of f.inventoryRecords){if(!Ot(C))continue;const y=C.baselineValueCents??0;if(!Number.isFinite(y))continue;const v=x(C.categoryId);if(v)for(const M of v.pathIds)i.set(M,(i.get(M)||0)+y)}const s=[],l={};let c=0,u=0,p=0,h=0;const b=C=>{const y=x(C);if(!y)return null;const v=i.get(C)||0,M=o.get(C)||0,g=M-v,A=v>0?g/v:null;return{marketId:C,marketLabel:y.pathNames.join(" / "),startValueCents:v,endValueCents:M,contributionsCents:M-v,netGrowthCents:g,growthPct:A}},w=new Set,O=C=>w.has(C)?[]:(w.add(C),(a.get(C)||[]).map(y=>b(y)).filter(y=>y!=null).sort((y,v)=>y.marketLabel.localeCompare(v.marketLabel)));for(const C of t){const y=b(C);y&&(l[C]=O(C),c+=y.startValueCents||0,u+=y.endValueCents||0,p+=y.contributionsCents||0,h+=y.netGrowthCents||0,s.push(y))}return p=u-c,h=u-c,{scopeMarketIds:t,rows:s,childRowsByParent:l,startTotalCents:c,endTotalCents:u,contributionsTotalCents:p,netGrowthTotalCents:h,hasManualSnapshots:!1}}function Be(e){return e==null||!Number.isFinite(e)?"—":`${(e*100).toFixed(2)}%`}function J(e){return e==null||!Number.isFinite(e)||e===0?"text-body-secondary":e>0?"text-success":"text-danger"}function an(){if(T.kind==="none")return"";const e=D("currencySymbol")||re,t=String(D("alphaVantageApiKey")||"").trim().length>0,a=(r,n)=>f.categories.filter(o=>!o.isArchived).filter(o=>!(r!=null&&r.has(o.id))).map(o=>`<option value="${o.id}" ${n===o.id?"selected":""}>${d(o.pathNames.join(" / "))}</option>`).join("");if(T.kind==="settings")return`
            ...
            <form id="settings-form">
              <div class="modal-body d-grid gap-3">
                <label class="form-label mb-0">
                  Currency code
                  <input class="form-control" name="currencyCode" value="${d((D("currencyCode")||ne).toUpperCase())}" maxlength="3" required />
                </label>
                <label class="form-label mb-0">
                  Currency symbol
                  <select class="form-select" name="currencySymbol">
                    ${va.map(r=>`<option value="${d(r.value)}" ${(D("currencySymbol")||re)===r.value?"selected":""}>${d(r.label)}</option>`).join("")}
                  </select>
                </label>
                <label class="form-label mb-0">
    ...
    `:""}return""}function q(){const e=window.scrollX,t=window.scrollY,a=S.querySelector('details[data-section="data-tools"]');a&&(pt=a.open);const r=S.querySelector('details[data-section="investments"]');r&&(ft=r.open),Fa(),Pa();const{inventoryColumns:n,categoryColumns:o,categoryDescendantsMap:i,filteredInventoryRecords:s,filteredCategories:l}=Qa(),c="Squirrl",u="Stash, sort, and track your investments locally with fast filters, clear totals, and private storage.",p="Settings",h=tn(i),b=Va(h.rows),w=f.filters.filter(m=>m.viewId==="categoriesList"),O=w.length?w.map(m=>m.label).join(" > "):"No filters",C=D("showMarketsGraphs")??Ee,y=l.some(m=>m.parentId==null),v=C&&y&&b.length>0,M=new Set([...te].filter(m=>{var $;return((($=h.childRowsByParent[m])==null?void 0:$.length)||0)>0}));M.size!==te.size&&(te=M);const g=h.startTotalCents>0?h.netGrowthTotalCents/h.startTotalCents:null,A=f.exportText||zt(),ye=s.map(m=>`
      ...
      `).join(""),oe=new Set(l.map(m=>m.id)),H=new Map;for(const m of l){const $=m.parentId&&oe.has(m.parentId)?m.parentId:null,k=H.get($)||[];k.push(m),H.set($,k)}for(const m of H.values())m.sort(($,k)=>$.sortOrder-k.sortOrder||$.name.localeCompare(k.name));const he=[],ie=(m,$)=>{const k=H.get(m)||[];for(const E of k)he.push({category:E,depth:$}),ie(E.id,$+1)};ie(null,0);const ge=String(D("alphaVantageApiKey")||"").trim().length>0,se=he.map(({category:m,depth:$})=>`
                  ...
                  ${h.rows.map(m=>{const $=h.childRowsByParent[m.marketId]||[],k=te.has(m.marketId);return`
                      ...
                      ${$.map(E=>`
                            <tr class="growth-child-row" data-parent-market-id="${d(m.marketId)}" ${k?"":"hidden"}>
                              ...
                              <td class="text-end ${J(E.growthPct)}">${d(Be(E.growthPct))}</td>
                            </tr>
                          `).join("")}
                    `}).join("")}
                </tbody>
